//
//  main.cpp
//  TutorialAdvancedLighting
//
//  Created by 梅宇宸 on 16/12/22.
...
int main()
{
    ...
    Shader shader(SHADER_FULL_DIR"blinnPhongLighting.vs", SHADER_FULL_DIR"blinnPhongLighting.frag");
    ...
    // Load textures
    GLuint floorTexture = loadTexture(TEXTURE_FULL_DIR"wood.jpg");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        std::cout << (blinn ? "Enable Blinn" : "Disable Blinn") << std::endl;
