//
//  main.cpp
//  TutorialShadowMapping
//
//  Created by 梅宇宸 on 16/12/29.
...
int main()
{
    ...
    Shader shader(SHADER_FULL_DIR"shadow_rendering.vs", SHADER_FULL_DIR"shadow_rendering.frag");
    Shader simpleDepthShader(SHADER_FULL_DIR"shadow_mapping_depth.vs", SHADER_FULL_DIR"shadow_mapping_depth.frag");
    Shader debugDepthQuad(SHADER_FULL_DIR"debug_quad.vs", SHADER_FULL_DIR"debug_quad.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glCullFace(GL_FRONT);   // Solve Peter Panning problems
