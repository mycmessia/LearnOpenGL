...
int main()
{
    ...
    Shader lampShader (SHADER_FULL_DIR"gl_FragCoord.vs", SHADER_FULL_DIR"gl_FragCoord.frag");
...
//    glEnable(GL_PROGRAM_POINT_SIZE);    // for gl_PointSize in vertex shader
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray (lampVAO);
        glDrawArrays (GL_TRIANGLES, 0, 36); // draw points
        glBindVertexArray (0);
