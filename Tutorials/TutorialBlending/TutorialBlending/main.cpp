...
#pragma region "object_initialization"
    ...
    // Load textures
    GLuint cubeTexture = loadTexture(TEXTURE_FULL_DIR"black_tiles.jpg");
    GLuint floorTexture = loadTexture(TEXTURE_FULL_DIR"metal.png");
    GLuint transparentTexture = loadTexture(TEXTURE_FULL_DIR"blending_transparent_window.png", true);
#pragma endregion
