//
//  main.cpp
//  TutorialDepthTesting
//
//  Created by 梅宇宸 on 12/5/16.
...
//    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
    ...
    glDepthFunc(GL_LESS);   // This is the default value
    glEnable(GL_STENCIL_TEST);
    glStencilFunc(GL_NOTEQUAL, 1, 0xFF);
    glStencilOp(GL_KEEP, GL_KEEP, GL_REPLACE);
    
    // Setup and compile our shaders
    Shader shader(SHADER_FULL_DIR"stencilTestVertex.glsl", SHADER_FULL_DIR"stencilTestFrag.glsl");
    Shader shaderSingleColor(SHADER_FULL_DIR"stencilTestVertex.glsl", SHADER_FULL_DIR"singleColorFrag.glsl");
...
#pragma region "object_initialization"
    ...
    // Load textures
    GLuint cubeTexture = loadTexture (TEXTURE_FULL_DIR"pattern4diffuseblack.jpg");
